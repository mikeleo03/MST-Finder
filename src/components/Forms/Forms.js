    ...
    const handleUpload = async (e) => {
        ...
        if (file) {
            ...
            if (res.success) {
                ...
                toast.fail('File configuration error :' + res.msg, {
            ...
            <div className="h-full mx-auto px-0 text-gray-600">
                <div className="h-full mx-auto flex flex-col space-y-5">
                    <div>
                        ...
                        <h3 className='text-lg py-1.5 font-semibold text-primaryBlue'>Fill this form to configure the graph.</h3>
                    </div>
                            ...
                            <label htmlFor="file-btn" className="w-full">
                                <div className="border-2 border-dashed border-white-3 rounded-2xl p-4 py-2.5 w-full flex flex-col items-center cursor-pointer bg-primaryYellow hover:bg-secondaryYellow duration-200 mt-3">
                                    <img
                                        ...
                                        alt=""
                                    />
                                    <p className="text-base font-bold text-white text-center" ref={textRef}>
                                        Upload adjacency matrix .txt file here...
                                    </p>
                                    <p className="text-base font-normal text-white text-center mt-1" ref={infoRef}>
                        ...
                        <div>
                            ...
                            <div className="flex flex-col mt-3 grid grid-cols-2 space-x-2 rounded-lg bg-secondaryYellow p-1.5">
                                <div>
                                    ...
                                    <label htmlFor="prim" className="text-base block cursor-pointer select-none rounded-xl p-2 text-center peer-checked:bg-primaryBlue font-bold peer-checked:text-white h-full flex justify-center items-center">Prim</label>
                                </div>
                                <div>
                                    ...
                                    <label htmlFor="kruskal" className="text-base block cursor-pointer select-none rounded-xl p-2 text-center peer-checked:bg-primaryBlue font-bold peer-checked:text-white h-full flex justify-center items-center">Kruskal</label>
                                </div>
                            </div>
                        </div>
                        <button
